...
## 
## Leave-one-out predictions usine genomewide markers and environmental covariables
## 
...
## Save the results
save("loeo_predictions_out", "lolo_predictions_out", "env_external_predictions_out", "loc_external_predictions_out",
     file = file.path(result_dir, "loo_predictions_fact_reg.RData"))
