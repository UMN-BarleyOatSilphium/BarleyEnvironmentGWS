...
6. Select all Trials
7. Select the Traits: "grain yield", "plant height", "heading date", "test weight", and "grain protein"
8. Select all Lines
...
12. Click the "Create file" button with instructions for one column for each trait (not used by TASSEL).
